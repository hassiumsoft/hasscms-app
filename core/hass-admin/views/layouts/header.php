...
use yii\helpers\Url;
use hass\admin\Module;
use hass\admin\widgets\Nav;
...
<header class="main-header">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
		...
		<div class="navbar-custom-menu">
			...
			<li>
                <a href="<?php echo $module->getWebUrl();?>" target="_blank"><i class="fa  fa-home"></i></a>
              </li>

				<li class="dropdown user user-menu"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"> <img
						src="<?php echo $module->getUserAvator();?>"
						class="user-image" alt="User Image" /> <span class="hidden-xs"><?php echo  $module->getUserName();?></span>
				</a>
				...
				<li>
                <a href="<?php echo Url::to( [ '/user/security/logout' ])?>" data-method='post'><i class="fa  fa-sign-out"></i></a>
              </li>
