...
class ToolController extends BaseController
{
    ...
    public function actionIndex()
    {
        ...
        foreach ($namespaces as $namespace => $dir) {
            ...
            foreach ($files as $file) {
                ...
                foreach ($methods as $method) {
                    ...
                    if ($method->name == "actions") {
                        ...
                        foreach ($actions as $actionId => $config) {
                            ...
                            $result[$moduleId]["permissions"][$route] = [
                                ...
                                "description" => $controllerId . "-" . Inflector::camel2words($actionId)
                            ];
                        }
                        continue;
                    }
                    ...
                    $result[$moduleId]["permissions"][$route] = [
                        "type" => Item::TYPE_PERMISSION,
                        "description" => $controllerId . "-" . Inflector::camel2words(substr($method->name, 6))
                    ];
                }
            }
        }
        ...
        $result["super"] = [
            ...
            'permissions' => array(
                \hass\rbac\Module::SUPER_PERMISSION => array(
                    'type' => Item::TYPE_PERMISSION,
